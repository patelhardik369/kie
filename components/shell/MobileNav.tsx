          ...
          >
            ...
            <nav className="min-h-0 flex-1 overflow-y-auto p-2">
              {links.map(({ href, label, Icon }) => (
                <Row key={href} href={href} active={isActive(href)} Icon={Icon}>
                  {label}
                </Row>
              ))}

              <Row href="/settings" active={isActive('/settings')} Icon={Gear}>
                Settings
              </Row>
...
function Row({
  ...
  return (
    ...
    >
      <Icon size={16} className={active ? 'text-(--color-accent)' : undefined} />
